Travel IQ -  Search Engine for Adventurous Travelers
...
3. RequestHandler.py
  ...
  d. This class will be invoked when the local server is initiated (see instructions of Set up Flask framework and run server) and when any action is initiated from the front end. 
